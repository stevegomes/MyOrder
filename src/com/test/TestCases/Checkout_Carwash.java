...
public class Checkout_Carwash {
	...
	@Test
	public void CheckoutCarwash() throws InterruptedException {
		...
		// Scripts Here
			...
			Thread.sleep(10000);
			driver.scrollTo("Carwash");
			Thread.sleep(2000);
			driver.findElement(By.xpath("//android.widget.TextView[@text='Carwash']")).click();
