...
public class Checkout_Themeparks {
	...
	@Test
	public void CheckoutThemeparks() throws InterruptedException {
		...
		// Scripts Here
			...
			Thread.sleep(10000);
			driver.findElement(By.xpath("//android.widget.TextView[@text='Themeparks']")).click();
			Thread.sleep(2000);
		driver.findElement(By.xpath("//android.widget.TextView[@text='Koningin Juliana Toren']")).click();
		Thread.sleep(5000);
		...
		driver.findElement(By.id("com.myorder.app:id/basket_open")).click();
		Thread.sleep(2000);
