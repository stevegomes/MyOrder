...
public class Checkout_Flowershops {
	...
	@Test
	public void CheckoutFlowershop() throws InterruptedException {
		...
		// Scripts Here
			...
			Thread.sleep(10000);
			driver.findElement(By.xpath("//android.widget.TextView[@text='Flowershops']")).click();
		Thread.sleep(2000);
		driver.findElement(By.xpath("//android.widget.TextView[@text='Wolters']")).click();
		Thread.sleep(5000);
		driver.findElement(By.xpath("//android.widget.TextView[@text='Rouw']")).click();
		Thread.sleep(2000);
		driver.findElement(By.xpath("//android.widget.TextView[@text='Rouwboeket Sereen']")).click();
		Thread.sleep(2000);
		...
		Thread.sleep(2000);
		driver.findElements(By.id("com.myorder.app:id/txtDelivery")).get(0).click();
		Thread.sleep(2000);
