...
public class ChargeWallet_CC{
	...
	@Test
	public void ChargeWalletCC() throws InterruptedException {
...
//			connect.scrollData(driver, 0.0, 700.0, 500.0, 700.0);
			...
			driver.findElements(By.id("com.myorder.app:id/payment_provider_view")).get(1).click();
