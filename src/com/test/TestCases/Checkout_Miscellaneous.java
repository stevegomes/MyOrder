...
public class Checkout_Miscellaneous {
	...
	@Test
	public void CheckoutMisc() throws InterruptedException {
		...
		// Scripts Here
			...
			Thread.sleep(10000);
			driver.scrollTo("Miscellaneous");
			Thread.sleep(2000);
			driver.findElement(By.xpath("//android.widget.TextView[@text='Miscellaneous']")).click();
//			driver.findElements(By.id("com.myorder.app:id/autoComplete")).get(0).sendKeys("Mob Carwash Demo");
//			driver.tap(1, 710, 1260, 1);
			Thread.sleep(2000);
		driver.findElement(By.xpath("//android.widget.TextView[@text='University Of Groningen']")).click();
		Thread.sleep(5000);
		driver.findElement(By.xpath("//android.widget.TextView[@text='Printtegoed']")).click();
		Thread.sleep(2000);
		driver.findElement(By.xpath("//android.widget.TextView[@text='10 euro tegoed']")).click();
		Thread.sleep(2000);
