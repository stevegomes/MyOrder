...
public class Checkout_Tankstations{
	...
	@Test
	public void CheckoutTankstations() throws InterruptedException {
...
//			connect.scrollData(driver, 0.0, 700.0, 500.0, 700.0);
			...
			Thread.sleep(10000);
			driver.findElement(By.xpath("//android.widget.TextView[@text='Tankstations']")).click();
...
//		JavascriptExecutor jse = (JavascriptExecutor) driver; jse.executeScript("UIATarget.localTarget().frontMostApp().keyboard().buttons()['Done\'].tap()");
		Thread.sleep(2000);
		driver.findElement(By.xpath("//android.widget.TextView[@text='Shell Hellevliet']")).click();
		Thread.sleep(2000);
		driver.findElement(By.xpath("//android.widget.TextView[@text='Brood']")).click();
		wait.until(ExpectedConditions.presenceOfElementLocated(By.xpath("//android.widget.TextView[@text='Broodje Kebab']")));
		driver.findElement(By.xpath("//android.widget.TextView[@text='Broodje Kebab']")).click();
		Thread.sleep(2000);
		...
		Thread.sleep(2000);
		driver.findElement(By.xpath("//android.widget.TextView[@text='CreditCard']")).click();
		Thread.sleep(2000);
