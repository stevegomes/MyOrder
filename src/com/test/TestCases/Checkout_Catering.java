...
public class Checkout_Catering {
	...
	@Test
	public void CheckoutCatering() throws InterruptedException {
		...
		// Scripts Here
			...
			Thread.sleep(10000);
			driver.findElement(By.xpath("//android.widget.TextView[@text='Catering']")).click();
		Thread.sleep(5000);
		driver.findElement(By.xpath("//android.widget.TextView[@text='Mob Catering Demo']")).click();
		Thread.sleep(5000);
		driver.findElement(By.xpath("//android.widget.TextView[@text='test']")).click();
